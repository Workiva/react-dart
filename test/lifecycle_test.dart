  ...
  group('React component lifecycle:', () {
    ...
    group('Component2', () {
      ...
      test('updates with correct lifecycle calls when `forceUpdate` is called', () {
        ...
        expect(
            ...
            equals([
              ...
              matchCall('componentDidUpdate', args: [expectedProps, initialState, null],
                  state: initialState),
      ...
      test(
          ...
          'componentDidUpdate', () {
        LifecycleTestHelper component = getDartComponent(render(
    ...
    test('updates state with correct lifecycle calls', () {
      ...
      expect(
          ...
          equals([
            ...
            isComponent2
                ? matchCall('componentDidUpdate',
                    args: [expectedProps, initialState, snapshot],
                    state: newState)
                : matchCall('componentDidUpdate',
                    args: [expectedProps, initialState], state: newState),
