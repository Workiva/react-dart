...
function _createReactDartComponentClass2(dartInteropStatics, componentStatics, jsConfig) {
  ...
  function (_React$Component2) {
    ...
    function ReactDartComponent2(props, context) {
      ...
      var initialStateFromGetInitialState = dartInteropStatics.handleGetInitialState(_this2.dartComponent); // If the returned state is empty, assume it's coming from the default implementation.
      // This is done to avoid changing the default getInitialState implementation to null, which would cause breakages.

      if (_this2.state && Object.keys(initialStateFromGetInitialState).length != 0) {
        throw 'Error: State cannot be initialized in both init and getInitialState';
      } else if (!_this2.state) {
        _this2.state = initialStateFromGetInitialState;
      }
  ...
  if (jsConfig) {
    ...
    if (jsConfig.propTypes) {
      ReactDartComponent2.propTypes = jsConfig.propTypes; //debugger;
    }
  }
...
module.exports = __webpack_require__(/*! ../../internals/path */ "./node_modules/core-js/internals/path.js").Reflect.deleteProperty;
...
var SLOPPY_METHOD = __webpack_require__(/*! ../internals/sloppy-array-method */ "./node_modules/core-js/internals/sloppy-array-method.js")('forEach'); // `Array.prototype.forEach` method implementation
...
var TO_STRING_TAG = __webpack_require__(/*! ../internals/well-known-symbol */ "./node_modules/core-js/internals/well-known-symbol.js")('toStringTag'); // ES3 wrong here
...
var propertyIsEnumerableModule = __webpack_require__(/*! ../internals/object-property-is-enumerable */ "./node_modules/core-js/internals/object-property-is-enumerable.js"); // all enumerable object keys, includes symbols
...
var requireObjectCoercible = __webpack_require__(/*! ../internals/require-object-coercible */ "./node_modules/core-js/internals/require-object-coercible.js"); // CONVERT_TO_STRING: true  -> String#at
...
var FAILS_ON_PRIMITIVES = __webpack_require__(/*! ../internals/fails */ "./node_modules/core-js/internals/fails.js")(function () {
...
if (toString !== ObjectPrototype.toString) {
  __webpack_require__(/*! ../internals/redefine */ "./node_modules/core-js/internals/redefine.js")(ObjectPrototype, 'toString', toString, {
    unsafe: true
  });
}
...
var anObject = __webpack_require__(/*! ../internals/an-object */ "./node_modules/core-js/internals/an-object.js"); // `Reflect.deleteProperty` method
...
module.exports = __webpack_require__(/*! ../../es/reflect/delete-property */ "./node_modules/core-js/es/reflect/delete-property.js");
