...
if (true) {
  (function () {
    ...
    var Placement =
    /*             */
    2; // Passive & Update & Callback & Ref & Snapshot
    ...
    var ReactTestUtils = {
      ...
      act: function (callback) {
        ...
        var result = ReactDOM.unstable_batchedUpdates(callback); // note: keep these warning messages in sync with
        ...
        ReactDOM.render(React.createElement('div', null), actContainerElement); // we want the user to not expect a return,
...
/***/ "scheduler/tracing":
/*!**************************************!*\
  !*** external "window.ReactTracing" ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = window.ReactTracing;
