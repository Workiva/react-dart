...
if (true) {
  (function () {
    ...
    var _assign = __webpack_require__(/*! object-assign */ "./node_modules/object-assign/index.js"); // Do not require this module directly! Use normal `invariant` calls with
    ...
    var enableSuspenseServerRenderer = true; // Helpers to patch console.logs to avoid logging during side-effect free
