...
class SyntheticKeyboardEvent extends SyntheticUIEvent {
  ...
  /// A string representation of a physical key on the keyboard
  /// _(as opposed to the character generated by pressing the key)_.
  ///
  ...
  /// positions on the input device rather than the characters associated with those keys;
  /// this is especially common when writing code to handle input for games that simulate a
  /// gamepad-like environment using keys on the keyboard.
  ///
  /// See <https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/code>
  external String get code;

  /// Returns the current state of the specified modifier [key]: `true` if the modifier is active
  /// (that is the modifier key is pressed or locked), otherwise, `false`.
  ///
  /// [key] must be one of the `KeyboardEvent.key` values which represent modifier keys.
...
class SyntheticMouseEvent extends SyntheticUIEvent {
  ...
  /// The difference in the X coordinate of the mouse pointer
  /// between the given event and the previous `mousemove` event.
  ///
  /// See <https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/movementX>
  external num get movementX;

  /// The difference in the Y coordinate of the mouse pointer
  /// between the given event and the previous `mousemove` event.
  ///
