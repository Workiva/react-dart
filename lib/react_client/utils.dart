...
/// A mapping from converted/wrapped JS handler functions (the result of [convertEventHandlers])
/// to the original Dart functions (the input of [convertEventHandlers]).
final Expando<Function> _originalEventHandlers = new Expando();

/// TODO: NOTE: This was not public before but is now
